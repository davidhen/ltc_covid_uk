...
Code and values for Figures 4 and 5.
...
No we have all the information combined in the `uk` object we can start plotting. Firstly the weekly excess by nation.
...
Figure 5 is a combination of 3 plots. First we show the individual plots and underlying tables
